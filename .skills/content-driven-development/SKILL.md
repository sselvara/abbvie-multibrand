...
- Remind user: "Restart your dev server with: `npm start` (this project uses a theme CSS builder alongside AEM; `npm start` runs both together)"
...
node .skills/content-driven-development/scripts/find-block-content.js <block-name>

# Search for specific variant
node .skills/content-driven-development/scripts/find-block-content.js <block-name> localhost:3000 <variant>

# Search on live site
node .skills/content-driven-development/scripts/find-block-content.js <block-name> main--repo--owner.aem.live

# Search on preview with variant
node .skills/content-driven-development/scripts/find-block-content.js <block-name> main--repo--owner.aem.page <variant>
```

**Examples:**
```bash
node .skills/content-driven-development/scripts/find-block-content.js hero
node .skills/content-driven-development/scripts/find-block-content.js hero localhost:3000 dark
node .skills/content-driven-development/scripts/find-block-content.js cards main--site--owner.aem.live three-up
```
